new Vue({
  ...
  methods: {
    ...
    addData: async function() {
      ...
      try {
    const response = await axios.post('https://m3h-hasegawa-recreation3.azurewebsites.net/api/INSERT', param);
    ...
    readData: async function() {
     ...
     try {
      ...
      const response = await axios.get('https://m3h-hasegawa-recreation3.azurewebsites.net/api/SELECT',{
            params: {
              PhoneNumber: this.PhoneNumber
            }
          });
    ...
    async updateData() {
      ...
      try {
        const response = await axios.put('https://m3h-hasegawa-recreation3.azurewebsites.net/api/UPDATE', param);
  ...
  async deleteData() {
    ...
    if (confirmCancel) {
     try {
          const response = await axios.post('https://m3h-hasegawa-recreation3.azurewebsites.net/api/DELETE', {
              PhoneNumber: this.PhoneNumber
          });
